...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: "၁၅ ကျပ်သား (ဒိန်ဝိုင်းကြီး)",
    category: "bottle-shells",
  ...
  },
  {
    ...
    name: "ဒိန်ဝိုင်းသေး Blue",
    category: "bottle-shells",
    description_en: "Dane Wine Tay (Small Round) Blue bottle shell.",
    description_mm: "ဒိန်ဝိုင်းသေး အပြာရောင် ရေသန့်ဘူးအခွံ။",
    material: "Food-grade PET",
    colors: ["Blue"],
    sizes: ["0.5L"],
    usage: ["Drinking water filling", "Retail packaging"],

...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: "၁၃ ကျပ်သား (ရှစ်ထောင့်)",
    category: "bottle-shells",
    description_en: "13 Kyat Thar (8 Dount) Blue Shal Shal bottle shell.",
    description_mm: "၁၃ ကျပ်သား ရှစ်ထောင့် အပြာ ရှယ်ရှယ် ရေသန့်ဘူးအခွံ။",
    material: "Food-grade PET",
    colors: ["Blue"],
    sizes: ["0.5L"],
    usage: ["Drinking water filling", "Retail packaging"],
